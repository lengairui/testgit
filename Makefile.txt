...
pldaplus_model.o: pldaplus_model.cc pldaplus_model.h common.o model.o
	$(MPICC) -c $(CFLAGS)  pldaplus_model.cc -o pldaplus_model.o

pldaplus_sampler.o: pldaplus_sampler.cc pldaplus_sampler.h common.o document.o model.o accumulative_model.o sampler.o
	$(CC) -c $(CFLAGS)  pldaplus_sampler.cc -o pldaplus_sampler.o
...
mpi_lda: mpi_lda.cc cmd_flags.o common.o document.o model.o accumulative_model.o sampler.o pldaplus_model.o pldaplus_sampler.o
	$(MPICC) $(CFLAGS) mpi_lda.cc cmd_flags.o common.o document.o model.o accumulative_model.o sampler.o pldaplus_model.o pldaplus_sampler.o -o mpi_lda
